...
<head>
    ...
    <!-- ========================= CSS here ========================= -->
    <link rel="stylesheet" href="<?= base_url('aset/user/') ?>assets/css/bootstrap-5.0.0-alpha-2.min.css" />
    <link rel="stylesheet" href="<?= base_url('aset/user/') ?>assets/css/LineIcons.2.0.css" />
    <link rel="stylesheet" href="<?= base_url('aset/user/') ?>assets/css/animate.css" />
    <link rel="stylesheet" href="<?= base_url('aset/user/') ?>assets/css/lindy-uikit.css" />
</head>
...
<body>
                        ...
                        <div class="col-lg-12">
                            <nav class="navbar navbar-expand-lg">
                                <a class="navbar-brand" href="index.html">
                                    <img src="<?= base_url('aset/user/') ?>assets/img/logo/logo.svg" alt="Logo" />
                                </a>
                ...
                <div class="row align-items-end">
                    <div class="col-lg-6">
                        <div class="hero-content-wrapper">
                            ...
                            <p class="mb-50 wow fadeInUp" data-wow-delay=".6s">Please, purchase full version of the
                                template to get all sections, features and permission to remove footer credit</p>
                            <div class="buttons">
                                <a href="https://rebrand.ly/flat-ud/" rel="nofollow" target="blank"
                                    class="button button-lg radius-10 wow fadeInUp" data-wow-delay=".7s">Purchase
                                    Now</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="hero-image">
                            <img src="<?= base_url('aset/user/') ?>assets/img/hero/hero-2/hero-img.svg" alt=""
                                class="wow fadeInRight" data-wow-delay=".2s">
                            <img src="<?= base_url('aset/user/') ?>assets/img/hero/hero-2/paattern.svg" alt=""
                                class="shape shape-1">
                        </div>
                    </div>
                </div>
    ...
    <section id="services" class="feature-section feature-style-2">
                    ...
                    <div class="row">
                        <div class="col-xl-7 col-lg-10 col-md-9">
                            <div class="section-title mb-60">
                                <h3 class="mb-15 wow fadeInUp" data-wow-delay=".2s">The future of designing starts here
                                </h3>
        ...
        <div class="feature-img wow fadeInLeft" data-wow-delay=".2s">
            <img src="<?= base_url('aset/user/') ?>assets/img/feature/feature-2-1.svg" alt="">
        </div>
    </section>
    <!-- ========================= feature style-2 end ========================= -->
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="about-image wow fadeInLeft" data-wow-delay=".2s">
                        <img src="<?= base_url('aset/temadmin/img/about/' . $about->foto) ?>" alt="">
                    </div>
                </div>
                <div class="col-lg-6">
    ...
    <div class="container pt-60 pb-60">
        <h4 class="wow fadeInUp" data-wow-delay=".2s">You're Using</h4>
        <h2 class="mb-30 wow fadeInUp" data-wow-delay=".4s">Free Lite Version of Template</h2>
        <p class="mb-50 wow fadeInUp" data-wow-delay=".6s">Please, purchase full version of the template to get all
            sections, features and permission to remove footer credit</p>
        <div class="buttons">
            <a href="https://rebrand.ly/flat-ud/" rel="nofollow" target="blank"
            ...
            <div class="row justify-content-center">
                <div class="col-xxl-5 col-xl-5 col-lg-7 col-md-10">
                    <div class="section-title text-center mb-60">
                        ...
                        <p class="wow fadeInUp" data-wow-delay=".4s">Stop wasting time and money designing and managing
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-4 col-md-8 col-sm-10">
                    <div class="single-pricing active wow fadeInUp" data-wow-delay=".4s">
                        ...
                        <div class="image">
                            <img src="<?= base_url('aset/user/') ?>assets/img/pricing/pricing-1/pricing-2.svg" alt="">
                        </div>
                    ...
                    <div class="col-xl-3 col-md-6 col-sm-10">
                        <div class="single-team wow fadeInUp" data-wow-delay=".2s">
                            ...
                            <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
                                ...
                                <?php $no = 1; foreach ($this->Cms_model->foto($a['id_barang']) as $b) { ?>
                                    <div class="carousel-item <?php if ($no == 1) {echo 'active';} ?>">
                                     <div class="image">
                                        <img src="<?= base_url('aset/temadmin/img/barang/' . $b['foto']) ?>" alt="">
                                        </div>
                                    </div>
                                    <?php } ?>
                                </div>
                            ...
                            <div class="info">
                                ...
                                <ul class="socials">
                                    <li>
                                        <a href="<?= $konfigurasi->wa ?>"> <i class="lni lni-facebook-filled"></i> </a>
                                    </li>
    ...
    <!-- ========================= galeri ========================= -->
    <section id="gallery" class="gallery-section gallery-style-1 mb-80">
        <div class="container">
            <div class="row grid" style="position: relative; height: 771.98px;">

                <?php foreach ($galeri as $a) { ?>
                    <div class="col-lg-4 col-md-6 grid-item" ">
                                    <div class=" single-gallery">
                        <div class="image">
                            <img src="<?= base_url('aset/temadmin/img/galeri/' . $a['foto']) ?>" alt="">
                        </div>
                        <div class="overlay">
            ...
            <?php } ?>
            <!-- <div class="col-lg-4 col-md-6 grid-item" style="position: absolute; left: 379.99px; top: 0px;">
                    <div class="single-gallery">
                        <div class="image">
                            <img src="<?= base_url('aset/user/') ?>assets/img/gallery/gallery-2.jpg" alt="">
                        </div>
                        <div class="overlay">
                            <div class="overlay-content">
                                <div class="action">
                ...
                <div class="col-lg-4 col-md-6 grid-item" style="position: absolute; left: 759.98px; top: 0px;">
                    <div class="single-gallery">
                        <div class="image">
                            <img src="<?= base_url('aset/user/') ?>assets/img/gallery/gallery-3.jpg" alt="">
                        </div>
                        <div class="overlay">
                            <div class="overlay-content">
                                <div class="action">
                ...
                <div class="col-lg-4 col-md-6 grid-item" style="position: absolute; left: 759.98px; top: 346.427px;">
                    <div class="single-gallery">
                        <div class="image">
                            <img src="<?= base_url('aset/user/') ?>assets/img/gallery/gallery-6.jpg" alt="">
                        </div>
                        <div class="overlay">
                            <div class="overlay-content">
                                <div class="action">
                ...
                <div class="col-lg-4 col-md-6 grid-item" style="position: absolute; left: 0px; top: 385.99px;">
                    <div class="single-gallery">
                        <div class="image">
                            <img src="<?= base_url('aset/user/') ?>assets/img/gallery/gallery-4.jpg" alt="">
                        </div>
                        <div class="overlay">
                            <div class="overlay-content">
                                <div class="action">
                ...
                <div class="col-lg-4 col-md-6 grid-item" style="position: absolute; left: 379.99px; top: 486.844px;">
                    <div class="single-gallery">
                        <div class="image">
                            <img src="<?= base_url('aset/user/') ?>assets/img/gallery/gallery-5.jpg" alt="">
                        </div>
                        <div class="overlay">
                            <div class="overlay-content">
                                <div class="action">
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="contact-form-wrapper">
                        <form action="<?= base_url('aset/user/') ?>assets/php/contact.php" method="POST">
                            <div class="row">
                                <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="client-logo wow fadeInUp" data-wow-delay=".2s">
                        <img src="<?= base_url('aset/user/') ?>assets/img/clients/brands.svg" alt="" class="w-100">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="copyright-wrapper wow fadeInUp" data-wow-delay=".2s">
                <p>Design and Developed by <a href="https://uideck.com" rel="nofollow" target="_blank">UIdeck</a>
                    Built-with <a href="#">Lindy UI Kit</a></p>
            </div>
        </div>
    </footer>
    <!-- ========================= footer style-1 end ========================= -->
    ...
    <!-- ========================= JS here ========================= -->
    <script src="<?= base_url('aset/user/') ?>assets/js/bootstrap.5.0.0.alpha-2-min.js"></script>
    <script src="<?= base_url('aset/user/') ?>assets/js/count-up.min.js"></script>
    <script src="<?= base_url('aset/user/') ?>assets/js/wow.min.js"></script>
    <script src="<?= base_url('aset/user/') ?>assets/js/main.js"></script>
</body>
