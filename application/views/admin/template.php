                ...
                <ul class="navbar-nav flex-fill w-100 mb-2">
                    <li class="nav-item">
                        ...
                        <a href="<?= base_url('admin/barang/') ?>" aria-expanded="false" class="nav-link">
                            ...
                            <span class="ml-3 item-text">Form barang</span>
                        </a>
                        ...
                        <a href="<?= base_url('admin/kariawan/') ?>" aria-expanded="false" class="nav-link">
                            <i class="fe fe-users fe-16"></i>
                            <span class="ml-3 item-text">Kariawan</span>
                        </a>
                    </li>
                </ul>
                <p class="text-muted nav-heading mt-4 mb-1">
                ...
                <ul class="navbar-nav flex-fill w-100 mb-2">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="collapse list-unstyled pl-4 w-100" id="profile">
                            <a class="nav-link pl-3" href="<?= base_url('admin/admin') ?>"><span
                                    class="ml-1">Registrasi</span></a>
                            <a class="nav-link pl-3" href="<?= base_url('admin/auth/logout') ?>"><span class="ml-1">Log
                                    out</span></a>
                        </ul>
                    </li>
                </ul>
