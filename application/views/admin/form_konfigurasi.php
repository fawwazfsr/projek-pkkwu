<div class="container">
    <div class="card shadow col- h-100 mb-4">
        ...
        <div class="card-body">
            <form Action="<?= base_url('admin/konfigurasi/update_konfigurasi') ?>" method="post"
                enctype="multipart/form-data">
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="inputEmail4">No Whatsapp</label>
                        <input type="text" class="form-control" name="wa" placeholder="Masukkan No whatsapp"
                            value="<?= $konfig->wa; ?>">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="inputEmail4">Instagram</label>
                        <input type="text" class="form-control" name="ig" placeholder="Masukkan instagram"
                            value="<?= $konfig->ig; ?>">
                    </div>
                    <div class="form-group col-md-6">
